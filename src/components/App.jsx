...
export default function App() {
  ...
  const downloadImage = () => {
    ...
    a.download = `madefoto.${gifUrl ? 'gif' : 'jpg'}`
    a.click()
  }
      ...
      >
        ...
        {!videoActive && (
          <button className="startButton" onClick={startVideo}>
            ...
            <h2 className="slogan">TRASFORMA LE TUE FOTO!</h2>
            <p>{didInitVideo ? 'Un attimo…' : 'Tocca ovunque per avviare la webcam'}</p>
          </button>
        )}
